...
>bar`,
	...
	describe("HTML-like tags in text", () => {
		...
		it("keeps numeric control entities escaped before terminal rendering", () => {
			const markdown = new Markdown("safe &#27;]52;c;payload&#7; &lt;ok&gt; &#x1F600;", 0, 0, defaultMarkdownTheme);
			...
			expect(plain).toContain("safe &#27;]52;c;payload&#7; <ok> 😀");
		});
	});
});
