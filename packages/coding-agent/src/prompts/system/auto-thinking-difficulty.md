...
- `max` — Highest-risk work where the model supports a true max tier: security, irreversible data changes, broad architecture, severe production incidents, or tasks where a wrong answer is expensive.
