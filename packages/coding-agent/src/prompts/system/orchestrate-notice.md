...
- Grinding a runs-first surface (FE screen, internal tool, demo) toward 100% green or coverage when its acceptance is a real render/run probe.
</anti-patterns>
</system-notice>
