...
1. **Resume the work** — if the assignment is not finished, call the next tool you would have called (edit, write, bash, grep, glob, etc.). NEVER yield. NEVER treat this reminder as a forced stop.
