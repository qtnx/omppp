import { PR_STATUS_FIELDS } from "@oh-my-pi/pi-tui/status-line/component";
...
export const statusLineHost: StatusLineHost<StatusLineHostSession> = {
	...
	lookupPullRequest: cwd =>
		github.run(cwd, ["pr", "view", "--json", PR_STATUS_FIELDS], AbortSignal.timeout(GH_COMMAND_TIMEOUT_MS)),
