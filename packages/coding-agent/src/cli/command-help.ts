...
export const herdrHelp = {
	description: "Manage the Herdr integration (install the `ompx` entrypoint herdr control needs)",
} satisfies CommandMetadata;
...
export const productPreviewHelp = { description: "Open a local Product Preview WebUI" } satisfies CommandMetadata;
