...
Copied verbatim from the MIT-licensed `skills/caveman/SKILL.md` in [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman). The Caveman Engine and other BSL-1.1 components are NOT bundled.
