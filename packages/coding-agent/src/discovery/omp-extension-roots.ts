 ...
 *    Marketplace installs are loaded by the `claude-plugins` provider and are
 *    excluded here.
 ...
 * "Claude Code Marketplace" and "OMP Extension Packages"; non-marketplace
 * `ompx plugin link` installs still surface through the plugin manager's
