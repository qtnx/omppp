/**
 * `ompx install <target>` — top-level convenience over `ompx plugin install` /
 * `ompx plugin link`.
 *
 * The docs advertise
 *
 *   ompx install ./my-extension
 *
...
/**
 * Heuristic used to decide whether `ompx install <target>` should `link` a
