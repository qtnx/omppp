...
export default class Worktree extends Command {
	...
	static args = {
		...
		// A positional action keeps `ompx worktree` (the no-arg form) useful.
		action: Args.string({
	...
	static examples = [
		"ompx worktree",
		"ompx worktree list --json",
		"ompx worktree add ../feature",
		"ompx worktree add -b feature ../feature origin/main",
		"ompx worktree add --detach ../review HEAD~2",
		"ompx worktree clear",
		"ompx worktree clear --dry-run",
		"ompx worktree clear --all",
	];
