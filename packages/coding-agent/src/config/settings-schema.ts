...
export const SETTINGS_SCHEMA = {
	...
	/**
	 * Legacy single-method compatibility selection. Persisted settings migrate
	 * this into `compaction.methodOrder`; the ordered setting takes precedence.
	 */
	"compaction.strategy": {
		type: "enum",
		values: ["context-full", "handoff", "shake", "snapcompact", "off"] as const,
		default: "context-full" as const,
	},
	...
	"computer.enabled": {
		...
		ui: {
			...
			group: "Available Tools",
			label: "Computer",
			description: "Enable the desktop computer tool; disabled while browser_use handles native computer actions",
		},
	},
