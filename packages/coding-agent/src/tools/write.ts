...
import { renderXdevCall, renderXdevResult, validateXdevDeviceArgs, type XdevDispatch } from "./xdev";
...
export class WriteTool implements AgentTool<typeof writeSchema, WriteToolDetails> {
	...
	readonly approval = (args: unknown): ToolTier => {
		...
		if (xdevTarget) {
			...
			try {
				const parsed = validateXdevDeviceArgs(inst, rawContent, "write-xdev-approval");
