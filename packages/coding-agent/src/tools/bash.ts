...
/** Model-supplied env names must be plain shell identifiers before they reach the child process. */
...
/**
 * Validate model-supplied env names and drop an empty map. Rejecting anything
 * that is not a plain shell identifier keeps `NAME=value` assignments from
 * smuggling shell syntax into the child environment.
 */
