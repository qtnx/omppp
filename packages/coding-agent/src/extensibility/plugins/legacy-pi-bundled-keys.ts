...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/cli/preload-env",
	...
	"@oh-my-pi/pi-coding-agent/cli/sandbox-flags",
	...
	"@oh-my-pi/pi-coding-agent/cli/update-release",
	"@oh-my-pi/pi-coding-agent/cli/usage-cli",
	"@oh-my-pi/pi-coding-agent/cli/web-search-cli",
	"@oh-my-pi/pi-coding-agent/cli/worker-selectors",
	...
	"@oh-my-pi/pi-coding-agent/commands/product",
	...
	"@oh-my-pi/pi-coding-agent/task/review-findings",
	"@oh-my-pi/pi-coding-agent/task/review-gate",
	...
	"@oh-my-pi/pi-coding-agent/tools/compact",
	"@oh-my-pi/pi-coding-agent/tools/conflict-detect",
	"@oh-my-pi/pi-coding-agent/tools/consult",
	...
	"@oh-my-pi/pi-coding-agent/tools/macos-sandbox",
	...
	"@oh-my-pi/pi-coding-agent/tools/present",
	...
	"@oh-my-pi/pi-coding-agent/tools/shake",
	"@oh-my-pi/pi-coding-agent/tools/sqlite-reader",
	"@oh-my-pi/pi-coding-agent/tools/ssh",
	"@oh-my-pi/pi-coding-agent/tools/super-review",
	...
	"@oh-my-pi/pi-coding-agent/utils/session-dump",
	...
	"@oh-my-pi/pi-coding-agent/utils/topic-relevance",
