 ...
 * loads `./telemetry-export-otlp` to register trace, log, and metric providers
 * so headless and embedded OMPx hosts can export telemetry without vendor
 * coupling while keeping the OTel SDK + exporter graph (~100ms) out of default startup.
 *
