...
export interface TaskItem {
	...
	self_review?: boolean;
	/**
	 * Legacy fork aliases accepted by the runtime for internal callers and
	 * historical transcripts. The model-facing schema remains agent-centric.
	 */
	id?: string;
	description?: string;
	role?: string;
...
export interface TaskParams {
	...
	self_review?: boolean;
	/**
	 * Legacy fork aliases accepted for compatibility with fork-owned internal
	 * callers. New tool calls use the agent-centric `name`/`task` fields.
	 */
	id?: string;
	description?: string;
	role?: string;
