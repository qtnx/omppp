...
export type AgentSessionEvent =
	...
	| {
			...
			reason: "requested" | "threshold" | "overflow" | "idle" | "incomplete" | "topic-switch";
	...
	/** A chip-bearing custom message was queued behind the streaming turn (browser annotation, skill prompt). */
