...
describe("ModelRegistry", () => {
	...
	describe("extended context", () => {
		...
		// A maximum-only configuration keeps the bundled standard window
		// (372K for Astra in this catalog) when the opt-in is off.
		test.each([
			["maximum-only override", "modelOverrides", undefined, 372_000],
			["paired override", "modelOverrides", 400_000, 400_000],
			["maximum-only custom model", "models", undefined, 372_000],
