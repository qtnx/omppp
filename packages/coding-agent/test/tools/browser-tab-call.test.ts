...
import { renderTabCall, TAB_VALUE_METHODS } from "@oh-my-pi/pi-coding-agent/tools/browser/tab-call";
...
describe("renderTabCall", () => {
	it("keeps the goal-driven act helper in the direct allowlist", () => {
		expect(TAB_VALUE_METHODS).toContain("act");
	});
