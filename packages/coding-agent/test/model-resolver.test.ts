...
import { type Api, type AuthStorage, Effort, type Model, type ModelSpec } from "@oh-my-pi/pi-ai";
...
describe("parseModelPattern", () => {
	...
	describe("patterns with valid thinking levels", () => {
		...
		test("max resolves as a real thinking level after the literal pattern misses", () => {
...
describe("resolveModelScope", () => {
	...
	test("expands exact canonical ids with max thinking selectors", async () => {
...
describe("selectHeadroomAwareModelPatterns", () => {
	...
	function createHeadroomAuthStorage(
		...
		return {
			usage: {
				headroom: (model: Model<Api>, opts?: HeadroomRoutingOptions) => {
