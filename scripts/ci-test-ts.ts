...
// Bun 1.3.14 can segfault (SIGSEGV, exit 132) when ~10 singleton/global-state
// files accumulate native state in one process, while 5-file chunks stay stable
// and keep every file covered without blanket skips.
