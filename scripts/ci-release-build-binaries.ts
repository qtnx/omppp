...
const targets: BinaryTarget[] = [
	{
		...
		outfile: "packages/coding-agent/binaries/ompx-darwin-arm64",
	},
	{
		id: "darwin-x64",
		platform: "darwin",
		...
		outfile: "packages/coding-agent/binaries/ompx-darwin-x64",
	},
	{
		id: "linux-x64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/ompx-linux-x64",
	},
	{
		id: "linux-arm64",
		platform: "linux",
...
async function generateBundle(): Promise<void> {
	if (isDryRun) {
		...
		console.log("DRY RUN bun run gen:tool-views");
	...
	await runCommand(["bun", "run", "gen:tool-views"], repoRoot);
